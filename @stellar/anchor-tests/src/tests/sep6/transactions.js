...
var transactionsTestGroup = "GET /transactions";
var tests = [];
    ...
    run: function (_config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                transactionsCall = {
                    request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl + transactionsEndpoint)
                };
                    ...
                    case 0:
                        ...
                        getTransactionsCall = {
                            request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl +
                                ...
                                ("?asset_code=" + config.assetCode + "&account=" + this.context.expects.clientKeypair.publicKey()), {
                                headers: {
    ...
    run: function (_config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                validationResult = jsonschema_1.validate(this.context.expects.sep6DepositTransactionsObj, sep6_1.transactionsSchema);
    ...
    run: function (_config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                validationResult = jsonschema_1.validate(this.context.expects.sep6WithdrawTransactionsObj, sep6_1.transactionsSchema);
                if (validationResult.errors.length !== 0) {
                    result.failure = failure_1.makeFailure(this.failureModes.INVALID_SCHEMA, {
                        errors: validationResult.errors.join("\n")
                    });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        getTransactionsCall = {
                            request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl +
                                transactionsEndpoint +
                                ("?asset_code=" + config.assetCode + "&account=" + clientKeypair.publicKey()), {
                                headers: {
                    ...
                    case 2:
                        ...
                        if (!responseBody)
                            return [2 /*return*/, result];
                        validationResult = jsonschema_1.validate(responseBody, sep6_1.transactionsSchema);
                        if (validationResult.errors.length !== 0) {
                            result.failure = failure_1.makeFailure(this.failureModes.INVALID_SCHEMA, {
                                errors: validationResult.errors.join("\n")
                            });
...
var honorsLimitParam = {
    ...
    failureModes: __assign({ NO_TRANSACTIONS: {
        ...
        }, DEPOSIT_INVALID_SCHEMA: deposit_1.returnsProperSchemaForKnownAccounts.failureModes.INVALID_SCHEMA, TRANSACTIONS_INVALID_SCHEMA: invalidTransactionsSchema }, failure_1.genericFailures),
    run: function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var result, callParams, getDepositCall, depositResponseBody, validatorResult, getTransactionsCall, transactionsResponseBody, transactionsValidatorResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, request_1.makeRequest(getDepositCall, 200, result, "application/json")];
                    case 1:
                        depositResponseBody = _a.sent();
                        if (!depositResponseBody)
                            return [2 /*return*/, result];
                        validatorResult = jsonschema_1.validate(depositResponseBody, sep6_1.depositSuccessResponseSchema);
                        ...
                        getTransactionsCall = {
                            request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl +
                                transactionsEndpoint +
                                ("?asset_code=" + config.assetCode + "&limit=1&account=" + this.context.expects.clientKeypair.publicKey()), {
                                headers: {
                                    Authorization: "Bearer " + this.context.expects.token
                                }
                            })
                    ...
                    case 2:
                        ...
                        if (!transactionsResponseBody)
                            return [2 /*return*/, result];
                        transactionsValidatorResult = jsonschema_1.validate(transactionsResponseBody, sep6_1.transactionsSchema);
...
var transactionsAreInDescendingOrder = {
    ...
    failureModes: __assign({ NO_TRANSACTIONS: {
        ...
        }, DEPOSIT_INVALID_SCHEMA: deposit_1.returnsProperSchemaForKnownAccounts.failureModes.INVALID_SCHEMA, TRANSACTIONS_INVALID_SCHEMA: invalidTransactionsSchema, MISSING_TRANSACTIONS: {
    ...
    run: function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var result, callParams, getDepositCall, depositResponseBody, validatorResult, getTransactionsCall, transactionsResponseBody, transactionsValidatorResult, previousStartTime, _i, _a, transaction, dateTime;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!config.sepConfig || !config.sepConfig["6"])
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        validationResult = jsonschema_1.validate(allTransactionsBody, sep6_1.transactionsSchema);
                        if (validationResult.errors.length !== 0) {
                        ...
                        getTransactionsOlderThanCall = {
                            request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl +
                                transactionsEndpoint +
                                ("?asset_code=" + config.assetCode + "&no_older_than=" + notEarliestTransaction.started_at + "&account=" + this.context.expects.clientKeypair.publicKey()), {
                                headers: {
                                    Authorization: "Bearer " + this.context.expects.token
                                }
                            })
                    ...
                    case 2:
                        ...
                        if (!noOlderThanBody)
                            return [2 /*return*/, result];
                        noOlderThanValidationResult = jsonschema_1.validate(noOlderThanBody, sep6_1.transactionsSchema);
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        getWithdrawTransactionsCall = {
                            request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl +
                                transactionsEndpoint +
                                ("?asset_code=" + config.assetCode + "&kind=withdrawal&account=" + this.context.expects.clientKeypair.publicKey()), {
                                headers: {
                                    Authorization: "Bearer " + this.context.expects.token
                                }
                            })
                    ...
                    case 1:
                        ...
                        if (!withdrawTransactions)
                            return [2 /*return*/, result];
                        validationResult = jsonschema_1.validate(withdrawTransactions, sep6_1.transactionsSchema);
                        if (validationResult.errors.length !== 0) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        getDepositTransactionsCall = {
                            request: new node_fetch_1.Request(this.context.expects.sep6TransferServerUrl +
                                transactionsEndpoint +
                                ("?asset_code=" + config.assetCode + "&kind=deposit&account=" + this.context.expects.clientKeypair.publicKey()), {
                                headers: {
                                    Authorization: "Bearer " + this.context.expects.token
                                }
                            })
                    ...
                    case 1:
                        ...
                        if (!depositTransactions)
                            return [2 /*return*/, result];
                        validationResult = jsonschema_1.validate(depositTransactions, sep6_1.transactionsSchema);
                        if (validationResult.errors.length !== 0) {
                            console.dir(validationResult.errors);
                            result.failure = failure_1.makeFailure(this.failureModes.INVALID_TRANSACTIONS_SCHMEA, { errors: validationResult.errors.join("\n") });
                            return [2 /*return*/, result];
