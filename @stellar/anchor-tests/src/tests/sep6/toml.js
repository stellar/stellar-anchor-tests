...
exports.hasTransferServerUrl = void 0;
var failure_1 = require("../../helpers/failure");
var tests_1 = require("../sep1/tests");
var tomlTestsGroup = "TOML tests";
exports.hasTransferServerUrl = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!this.context.provides.sep6TransferServerUrl) {
                    result.failure = failure_1.makeFailure(this.failureModes.TRANSFER_SERVER_NOT_FOUND);
...
exports["default"] = [exports.hasTransferServerUrl];
