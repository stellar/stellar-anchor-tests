            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        result = { networkCalls: [] };
                        infoCall = {
                            request: new node_fetch_1.Request(this.context.expects.transferServerUrl + "/info")
                        };
                    ...
                    case 1:
                        ...
                        validationResult = jsonschema_1.validate(this.context.provides.infoObj, sep24_1.infoSchema);
...
exports.assetCodeEnabledForDeposit = {
    ...
    run: function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var result, depositAssets, assetCode;
            return __generator(this, function (_a) {
                result = { networkCalls: [] };
                depositAssets = this.context.expects.infoObj.deposit;
                if (!config.assetCode) {
...
exports.assetCodeEnabledForWithdraw = {
    ...
    run: function (config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                result = { networkCalls: [] };
                withdrawAssets = this.context.expects.infoObj.withdraw;
                if (!config.assetCode) {
